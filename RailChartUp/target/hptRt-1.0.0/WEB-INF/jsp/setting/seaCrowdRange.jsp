...
<meta charset="UTF-8">
	...
	$(document).ready( function() {
		...
		$("#btnUpdate").click(function(){
			 $("#content").load("/setting/seaCrowdRangeUpdate.do"); 
		});
