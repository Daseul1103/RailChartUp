	...
	$(document).ready( function() {
		...
		$("#yearCrowdRangeUpdateForm").submit( function(event){
			...
			if(keyButton=="btnSubAll"){//전 범위 변경
				conUrl="/setting/yearCrowdRangeUpdate/all_"+loginId+".ajax";
			}else{//현재 화면만 변경
				conUrl="/setting/yearCrowdRangeUpdate/normal_"+loginId+".ajax";
			}
			//유효성 체크
		...
		<div class="setTbDiv">
			<table class='setTbList-nonbt'>
				<tr>
					...
					<td>
						<div class= inputSet>
							<input type="number" min="0" max="560" id ="yearWgtRlxDv" name="yearWgtRlxDv" value=${data.yearWgtRlxDv} maxlength="3" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)' class="1" required>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class= inputSet>
							<input type="number" min="0" max="560" id ="yearWgtUsDv" name="yearWgtUsDv" value=${data.yearWgtUsDv} maxlength="3" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)' class="3" required>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class= inputSet>
							<input type="number" min="0" max="560" id ="yearWgtCauDv" name="yearWgtCauDv" value=${data.yearWgtCauDv} maxlength="3" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)' class="5" required>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class= inputSet>
							<input type="number" min="0" max="560" id ="yearWgtCwdDv" name="yearWgtCwdDv" value=${data.yearWgtCwdDv} maxlength="3" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)' class="5" required>
						</div>
					</td>
				</tr>
				<tr>
