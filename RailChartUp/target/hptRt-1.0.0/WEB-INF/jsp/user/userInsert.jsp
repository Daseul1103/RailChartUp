				...
				<tr>
					...
					<td>
						<div class ="searchBtnDiv">
							...
							<div class="btn btn-primary btn-sm" id="searchBtn" name="searchBtn_userId" class="searchBtn"></div>
						</div>
				...
				<tr>
					...
					<input type="hidden" id ="userPhone" name="userPhone" class="form-control">
						<div class= inputPhone>
							...
							<p> - </p>
							<input type="text" id="userPhone2" maxlength="4" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)' class="form-control">
							<p> - </p>
							<input type="text" id="userPhone3" maxlength="4" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)' class="form-control">
						</div>					
					</td>
				</tr>
				<tr>
