...
public class TcmsRcvVO {
	...
	public String toString() {
		return "TcmsRcvVO [sndDt=" + sndDt + ", trainNum=" + trainNum + ", carNum=" + carNum + ", rcvDt=" + rcvDt
				+ ", trainType=" + trainType + ", trainDirect=" + trainDirect + ", carWgt1=" + carWgt1 + ", carWgt2="
				+ carWgt2 + ", carWgt3=" + carWgt3 + ", carWgt4=" + carWgt4 + ", carWgt5=" + carWgt5 + ", carWgt6="
				+ carWgt6 + ", carWgt7=" + carWgt7 + ", carWgt8=" + carWgt8 + "]";
	}
