...
<script>
	$(document).ready(function(){
		...
		//console.log("tcms 수신로그  화면 진입");
		iidx = 0;
		
		var nowLogDt = moment().format("YYYY-MM-DD");
		var ajaxData = ajaxMethod("/eventLog/tcmsRcvList.ajax", {"sDate":nowLogDt,"eDate":nowLogDt, "tagId":1});
		...
		var toDate = new Date();
		 $('#datetimepicker1').datetimepicker({
			...
			var nwData = ajaxMethod("/eventLog/tcmsRcvList.ajax", {"sDate":$("#fromDate").val(),"eDate":$("#toDate").val(),"tagId":$("#filterSb").val()});
