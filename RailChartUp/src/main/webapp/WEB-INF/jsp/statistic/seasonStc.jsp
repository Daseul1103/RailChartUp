...
<meta charset="utf-8">
	<script>
		...
		$(document).ready( function() {
			...
			var defaultD  = moment().format("YYYY");
			 ...
			 $('#datetimepicker1').datetimepicker({
				...
				//날짜 변경시
			 	...
			 	var txtDt=$("#sdate").val();
				//막대그래프 갱신
				ajaxData=ajaxMethod("/statistic/seaTermByRange.ajax", {"sDate":txtDt});
			...
			var ajaxData=ajaxMethod("/statistic/seaTermByRange.ajax", {"sDate":$("#sdate").val()});
			var alData = ajaxData.data;
			//최초 생성
			stcReNew(alData);
			
			chart = barChart("chart",1200,300);
	...
	<h1 class='title' style='text-align:center; font-weight:bold;'>계절별 통계</h1>
	<div class="main-st">
		<!-- datetimepicker -->
