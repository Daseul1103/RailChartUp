	...
	$(document).ready( function() {
		...
		$("#monCrowdRangeUpdateForm").submit( function(event){
			...
			if(keyButton=="btnSubAll"){//전 범위 변경
				conUrl="/setting/monCrowdRangeUpdate/all_"+loginId+".ajax";
			}else{//현재 화면만 변경
				conUrl="/setting/monCrowdRangeUpdate/normal_"+loginId+".ajax";
			}
			//유효성 체크
		...
		<div class="setTbDiv">
			<table class='setTbList-nonbt'>
				<tr>
					...
					<td>
						<div class= inputSet>
							<input type="number" min="0" max="560" id ="monWgtRlxDv" name="monWgtRlxDv" value=${data.monWgtRlxDv} maxlength="3" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)' class="1" required>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class= inputSet>
							<input type="number" min="0" max="560" id ="monWgtUsDv" name="monWgtUsDv" value=${data.monWgtUsDv} maxlength="3" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)' class="3" required>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class= inputSet>
							<input type="number" min="0" max="560" id ="monWgtCauDv" name="monWgtCauDv" value=${data.monWgtCauDv} maxlength="3" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)' class="5" required>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class= inputSet>
							<input type="number" min="0" max="560" id ="monWgtCwdDv" name="monWgtCwdDv" value=${data.monWgtCwdDv} maxlength="3" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)' class="5" required>
						</div>
					</td>
				</tr>
				<tr>
